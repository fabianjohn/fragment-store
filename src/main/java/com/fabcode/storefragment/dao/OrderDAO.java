...
import com.fabcode.storefragment.entity.Order;
import com.fabcode.storefragment.entity.OrderDetail;
import com.fabcode.storefragment.entity.Product;
import com.fabcode.storefragment.model.CartInfo;
import com.fabcode.storefragment.model.CartLineInfo;
import com.fabcode.storefragment.model.CustomerInfo;
import com.fabcode.storefragment.model.OrderDetailInfo;
import com.fabcode.storefragment.model.OrderInfo;
...
public class OrderDAO {
	...
	String mailContent = "<p>Dear  " +  cartInfo.getCustomerInfo().getName();  //.getName() + " </p>";
		  ...
		  String verifyURL = siteURL + "/verify?code=" + cartInfo.getOrderNum() ;  //getVerificationCode();
		   ...
		   helper.setFrom("fabita.aws@gmail.com", senderName);
		   helper.setTo(cartInfo.getCustomerInfo().getEmail());
